...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="#">Welcome <% String email1=(String)session.getAttribute("email"); out.print(email1);%> </a>
      </li>
   
   
      <li class="nav-item">
        <a class="nav-link" href="FlightBooked.jsp?email=<%String email3=(String)session.getAttribute("email");  out.print(email3); %>">Booking History</a>
      </li>
  ...
  <%	String msg =(String)session.getAttribute("success"); if(msg=="yes"){ %>
  ...
  <div class="form-row">
    ...
    <label for="inputCity">Available Date</label>
      ...
      <input type="hidden" value="<% String email2=(String)session.getAttribute("email"); out.print(email2);%>" name="email">
...
%>
   <tr>
      ...
      <td><a class="btn btn-info" href="booking.jsp?f_id=<%= rs.getInt("flight_number") %>&email=<% String email=(String)session.getAttribute("email"); out.print(email);%>">Book Flight</a></td>
       </tr>
   <%} %>
  </tbody>
